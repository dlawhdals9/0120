...
//		날짜 및 시간의 출력서식 지정 방법, 서식 문자를 제외한 나머지 문자는 입력한 그대로 출력된다.
...
//		sdf.format(날짜 데이터)
		...
		SimpleDateFormat sdf2 = new SimpleDateFormat("yyyy.MM.dd(E) h:mm:ss.SSS");
		System.out.println(sdf2.format(date));
		
		
//		currentTimeMillis() : 1970년 1월 1일 자정부터 이 메소드가 실행되는 순간까지 지난 시간을 밀리초(1/1000 초) 단위로 얻어온다.
